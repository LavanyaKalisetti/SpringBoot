...
public class CustomerOperationsAPI {
	...
	public ResponseEntity<String> showCustomerData(){
		...
		public ResponseEntity<String> updateCustomer(){
			...
			return new ResponseEntity<String>("Udating Complete Customer Details",HttpStatus.OK);
		...
		public ResponseEntity<String> updateCustomerEmail(){
			...
			return new ResponseEntity<String>("Udating the Customer Email Info",HttpStatus.OK);
